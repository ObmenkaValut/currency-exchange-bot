...
export const AI_PROMPT_TEMPLATE = `Канал обмена валют/крипты/финансовых операций разных типов. Пропускай ТОЛЬКО если текст явно про покупку/продажу/обмен валют (USD, EUR, UAH, BTC, USDT и т.д.)/финансовые операции, займы, котировки валют, переводы, бизнес услуги, а также декоративные символы Юникода (круги, блоки, флаги, буквы в рамках), если они являются частью оформления сообщения. Блокируй всё остальное: спам, мат, продажу курсов, бессмысленные символы, нерелевантное, и все схожее.
